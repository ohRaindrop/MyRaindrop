...
$select= "SELECT foto, nome, prezzo, descrizione, denominazione FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f  WHERE nominata='Materie prime';";
...
echo("<center><h1><b>Lista di tutte le materie prime:</b></h1></center>");
while($riga)
{
