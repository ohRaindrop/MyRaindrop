...
$select= "SELECT denominazione, titolare FROM Fornitore;";
...
if(!$riga)
{
  echo("Nessuna marca trovata. <br><br> Errore: ".mysql_error());
  exit();
}

echo("<center><h1>Le marche presenti presso il nostro sito sono:</h1></center>");
while($riga)
{
  echo("  $riga[denominazione] ");
  echo(" di $riga[titolare] ");
  echo("<br><br>");
