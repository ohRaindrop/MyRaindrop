...
$select= "SELECT foto, nome, prezzo, descrizione, nominata FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f WHERE denominazione='Giardino di Arianna';";
...
echo("<center><h1><b>Lista di tutti i prodotti Giardino di Arianna:</b></h1></center>");
while($riga)
{
  ...
  echo("Categoria di appartenenza:  $riga[nominata].");
  echo("<br><br>");
