...
$select= "SELECT foto, nome, prezzo, descrizione, denominazione FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f  WHERE nominata='Balsamo' OR nominata='Shampoo';";
...
echo("<center><h1><b>Lista di tutti i shampoo e balsamo:</b></h1></center>");
while($riga)
{
