...
$select= "SELECT foto,nome,prezzo,descrizione FROM Prodotti WHERE prezzo<='$_POST[prezzo]' ORDER BY prezzo;";
...
echo("<center><h1><b>Lista dei prodotti con le caratteristiche richieste:</b></h1></center>");
while($riga)
{
