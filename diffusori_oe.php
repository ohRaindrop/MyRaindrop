...
$select= "SELECT foto, nome, prezzo, descrizione, denominazione FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f  WHERE nominata='Diffusori' OR nominata='Oli essenziali';";
...
echo("<center><h1><b>Lista di tutti i diffusori ambientali e gli oli essenziali:</b></h1></center>");
while($riga)
{
