...
$select= "SELECT foto, nome, prezzo, descrizione, nominata FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f WHERE denominazione='Cuccioli di uomo';";
...
echo("<center><h1><b>Lista di tutti i prodotti Cuccioli d'uomo:</b></h1></center>");
while($riga)
{
