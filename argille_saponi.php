...
$select= "SELECT foto, nome, prezzo, descrizione, denominazione FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f  WHERE nominata='Argille' OR nominata='Saponi';";
...
echo("<center><h1><b>Lista di tutte le argille e i saponi:</b></h1></center>");
while($riga)
{
