...
$select= "SELECT foto, nome, prezzo, descrizione, nominata FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f WHERE denominazione='Erbe di Janas';";
...
echo("<center><h1><b>Lista di tutti i prodotti Erbe di Janas:</b></h1></center>");
while($riga)
{
