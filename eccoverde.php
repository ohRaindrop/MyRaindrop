...
$select= "SELECT foto, nome, prezzo, descrizione, nominata FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f WHERE denominazione='Eccoverde';";
...
echo("<center><h1><b>Lista di tutti i prodotti Eccoverde:</b></h1></center>");
while($riga)
{
