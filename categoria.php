...
$select= "SELECT foto,nome,prezzo, descrizione FROM (Prodotti NATURAL JOIN Categoria)WHERE categoria.nominata='$_POST[nominata]' ORDER BY nome;";
...
echo("<h1><b>Lista dei prodotti della categoria richiesta</b></h1>");
while($riga)
{
  echo("<img src='$riga[foto]' width=200px height=200px> $riga[nome] ad euro: $riga[prezzo] € <br>");
