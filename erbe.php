...
$select= "SELECT foto, nome, prezzo, descrizione, denominazione FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f  WHERE nominata='Erbe' OR nominata='Henna';";
...
echo("<center><h1><b>Lista di tutte le erbe e gli hennè :</b></h1></center>");
while($riga)
{
