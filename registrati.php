...
if(!mysql_query($insert))
{
...
else
 {
   ...
   echo ("<a href='prodotti.htm'> Prosegui con gli acquisti. </a>.");
 }
echo("<br>");
mysql_close($con);
?>
...
<br>
<a href="http://soldi.mercurio.lan/esercizi/PROGETTO_ECOLOGIA/login.htm"> Ritorna alla pagina di Log in. </a>
