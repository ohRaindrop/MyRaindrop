...
$select= "SELECT foto, nome, prezzo, descrizione, denominazione FROM (Categoria NATURAL JOIN Prodotti) INNER JOIN Fornitore ON prodotti.id_f=fornitore.id_f  WHERE nominata='Make up';";
...
echo("<center><h1><b>Lista di tutti i prodotti per il make up :</b></h1></center>");
while($riga)
{
